...
class FilterTableChildren extends Component
{
    /**
    ...
    */
    ...
    {
        $this->response       = [];
        $this->filterUrl      = 'sub/' . $this->parentSlug . '?paginate=true';
    ...
    */
    ...
    {
        return view('livewire.admin.category.index.filter-table-children');
    }
}
