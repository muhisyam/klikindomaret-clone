...
class PromotionBannerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'banner_image_name' => ['nullable', 'image', 'mimes:jpg,png,jpeg,webp', 'max:512'],
            'deploy_status' => [Rule::in(DeployStatus::class)],
            'route_name' => [Rule::in(SelectSpesificRoute::class)],
            'redirect_url' => ['nullable', 'string', 'max:200'],
            'redirect_out_site_url' => ['nullable', 'string', 'max:200'],
