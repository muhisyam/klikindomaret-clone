    ...
    <div class="channel-wrapper min-h-[212px] py-4 px-6 rounded-lg">
        ...
        <div class="swiper list-channel">
            <div class="swiper-wrapper">
                <div class="swiper-slide item-channel">
                ...
                <div class="swiper-slide item-channel">
                    <a href="https://travel.klikindomaret.com/" data-name='Travel'>
                        <div class="media w-[80px] p-4 bg-white rounded-md shadow">
                            ...
                            <img src="https://assets.klikindomaret.com/products/banners/icon_travel_new2.jpg" alt="Icon Travel">
                        </div>
                        <h3 class="desc mt-2 text-center text-sm">
                            Travel
                        </h3>
                ...
                <div class="swiper-slide item-channel">
                    <a href="https://tiket.klikindomaret.com/" data-name='Tiket Wahana'>
                        <div class="media w-[80px] p-4 bg-white rounded-md shadow">
                            ...
                            <img src="https://assets.klikindomaret.com/products/banners/Icon_Tiket.png" alt="Icon Tiket">
                        </div>
                        <h3 class="desc mt-2 text-center text-sm">
                            Tiket Wahana
                        </h3>
                ...
                <div class="swiper-slide item-channel">
                    <a href="https://virtual.klikindomaret.com/category/IndomaretPoinku" data-name='Indomaret Poinku'>
                        <div class="media w-[80px] p-4 bg-white rounded-md shadow">
                            ...
                            <img src="https://assets.klikindomaret.com/products/banners/logoPoinku.png" alt="Icon Poinku">
                        </div>
                        <h3 class="desc mt-2 text-center text-sm">
                            Indomaret Poinku
                        </h3>
