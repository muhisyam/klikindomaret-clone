    ...
    <div class="container mx-auto max-w-7xl h-full">
        <div class="top__section flex justify-between">
            <div class="left__side flex text-xs">
                <div class="app__download my-auto">
                    <div id="dropdownAppDownload" data-dropdown-toggle="dropdownApp" data-dropdown-offset-distance="5" data-dropdown-placement="bottom-start" class="flex items-center me-5">
                    ...
                    <div id="dropdownApp"class="dropdown__app z-10 bg-white rounded-lg shadow w-[240px] hidden">
                        <div class="wrapper__dropdownApp p-5">
                            <div class="qrcode">
                ...
                <div class="socmed flex items-center me-6">
                ...
                <div class="user__service my-auto">
                    <div id="dropdownUserService" data-dropdown-toggle="dropdownService"  data-dropdown-offset-distance="5" data-dropdown-placement="bottom-end" class="flex items-center">
                        <span class="icon"><i class="ri-customer-service-fill"></i></span>
                        <span class="mx-1.5">Layanan Pelanggan</span>
                        <span class="icon"><i class="ri-arrow-drop-down-line"></i></span>
                    </div>

                    <div id="dropdownService" class="dropdown__service z-10 bg-white rounded-lg shadow w-[275px] hidden text-[#313131]">
                        <div class="wrapper__dropdownService pt-4 px-3 pb-2">
                            <div class="call__center mb-2.5">
                            ...
                            <div class="email">
                                ...
                                <div class="desc flex">
                                    ...
                                    <div class="wrapper__desc my-auto">
            ...
            <div class="right__side h-8 w-1/3 rounded-b-xl drop-shadow-md bg-slate-50 overflow-hidden cursor-pointer">
                <div class="first__box flex mx-3.5 mt-1 text-sm">  
                    <span class="icon text-xs mb-7"><i class="ri-map-pin-fill"></i></span>
                    <span class="guest__info ms-2 mt-[-3px] leading-7 text-xs">
        ...
        <div class="bottom__section flex justify-between pt-3 pb-4">
            <div class="left__side flex items-center w-[80%] max-w-[60rem]">
                <div class="logo">
