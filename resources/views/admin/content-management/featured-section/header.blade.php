<header class="header mb-6">
    <section class="top-section flex items-center justify-between">
        <div class="left-side min-w-[180px]">
            <h1 class="title text-2xl font-bold">List Konten Unggulan</h1>
        </div>
        ...
        <div class="right-side min-w-[180px]">
            <div class="flex items-center float-right">
                ...
                <x-modal :section="$section" :showCondition="$show">
                    ...
                    @push('components')
                        @livewire('admin.content-management.featured-section.modal-input', [
                            'section' => $section,
                            'showCondition' => $show,
                        ])
                    @endpush
                ...
                <x-button class="h-8 px-2 group hover:bg-light-gray-50">
                    <x-nav-link href="{{ route('featureds.create') }}">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center text-sm">
                ...
                <li class="flex items-center text-[#95989A]">
                    ...
                    <a href="{{ route('featureds.index') }}" class="hover:text-[#0079C2]">Konten Unggulan</a>
                </li>
                <li class="flex items-center text-[#95989A]">
                    <i class="ri-arrow-right-s-line mx-2"></i>
                    <span class="text-black">List Konten Unggulan</span>
                </li>
            </ol>
        </nav>
    </section>
