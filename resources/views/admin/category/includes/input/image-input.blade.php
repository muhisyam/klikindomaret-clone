<div class="item-input-group mb-4">
    ...
    <input id="form-input-image" type="file" accept="image/" class="hidden">
    ...
    <div class="item-image-uploaded">
        <div class="item-image-wrapper flex items-center justify-between border border-[#eee] rounded p-2 is-invalid">
            <div class="image-info-wrapper w-11/12 flex items-center">
                ...
                <div class="info">
                    <p class="text font-bold line-clamp-1 text-ellipsis">OBAT HERBAL TRADISIO OBAT HERBAL TRADISIO OBAT HERBAL TRADISIO.jpeg</p>
