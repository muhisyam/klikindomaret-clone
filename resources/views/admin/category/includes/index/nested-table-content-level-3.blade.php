<tr class="relative">
    ...
    <td class="py-2 px-4 w-[50px]">
        <div class="relative">
            <button type="button" class="block rounded p-1 px-2 mx-auto hover:bg-[#fbde7e] hover:text-[#0079c2]" onclick="btnDataAction(this)" aria-label="Data action" data-target-action="{{ $categoryLvl3['slug'] }}" data-tooltip-target="action-tooltip-{{ $key }}" data-tooltip-placement="bottom">
