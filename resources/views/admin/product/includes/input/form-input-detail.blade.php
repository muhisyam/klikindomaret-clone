<div class="item-input-group mb-4">
    ...
    <select id="form-select-store" name="store_id">
        <option></option>
...
<div class="item-input-group mb-4">
    ...
    <select id="form-select-category" name="category_id" class="is-invalid">
        <option></option>
...
<div class="item-input-group mb-4">
    ...
    <input id="form-input-normal-price" type="number" name="normal_price" class="h-10 w-full border border-[#ccc] rounded py-2 px-3 focus:ring-transparent">
</div>
<div class="item-input-group mb-4">
