...
<div id="addon-1" class="item-input-group mb-4">
    <label for="form-input-desc" class="block text-sm mb-1">Deskripsi Tambahan #1</label>
    <div id="form-input-desc" class="w-full">
        ...
        <textarea id="desc-info" name="addon-desc-info-1" cols="30" rows="5" placeholder="Deskripsi..." class="w-full border border-[#ccc] rounded py-2 px-3 focus:ring-transparent"></textarea>
    </div>
</div>
<div id="addon-2" class="item-input-group mb-4 hidden">
    <label for="form-input-desc" class="block text-sm mb-1">Deskripsi Tambahan #2</label>
    <div id="form-input-desc" class="w-full">
        <input id="desc-label" type="text" name="addon-desc-label" placeholder="Label Deskripsi..." class="w-full h-10 border border-[#ccc] rounded py-2 px-3 mb-4 focus:ring-transparent">
        <textarea id="desc-info" name="addon-desc-info-2" cols="30" rows="5" placeholder="Deskripsi..." class="w-full border border-[#ccc] rounded py-2 px-3 focus:ring-transparent"></textarea>
    </div>
</div>
<div id="addon-3" class="item-input-group mb-4 hidden">
    <label for="form-input-desc" class="block text-sm mb-1">Deskripsi Tambahan #3</label>
    <div id="form-input-desc" class="w-full">
        <input id="desc-label" type="text" name="addon-desc-label" placeholder="Label Deskripsi..." class="w-full h-10 border border-[#ccc] rounded py-2 px-3 mb-4 focus:ring-transparent">
        <textarea id="desc-info" name="addon-desc-info-3" cols="30" rows="5" placeholder="Deskripsi..." class="w-full border border-[#ccc] rounded py-2 px-3 focus:ring-transparent"></textarea>
    </div>
</div>
<div id="addon-4" class="item-input-group mb-4 hidden">
    <label for="form-input-desc" class="block text-sm mb-1">Deskripsi Tambahan #4</label>
    <div id="form-input-desc" class="w-full">
        <input id="desc-label" type="text" name="addon-desc-label" placeholder="Label Deskripsi..." class="w-full h-10 border border-[#ccc] rounded py-2 px-3 mb-4 focus:ring-transparent">
        <textarea id="desc-info" name="addon-desc-info-4" cols="30" rows="5" placeholder="Deskripsi..." class="w-full border border-[#ccc] rounded py-2 px-3 focus:ring-transparent"></textarea>
    </div>
</div>
<div id="addon-5" class="item-input-group mb-4 hidden">
    <label for="form-input-desc" class="block text-sm mb-1">Deskripsi Tambahan #5</label>
    <div id="form-input-desc" class="w-full">
        <input id="desc-label" type="text" name="addon-desc-label" placeholder="Label Deskripsi..." class="w-full h-10 border border-[#ccc] rounded py-2 px-3 mb-4 focus:ring-transparent">
        <textarea id="desc-info" name="addon-desc-info-5" cols="30" rows="5" placeholder="Deskripsi..." class="w-full border border-[#ccc] rounded py-2 px-3 focus:ring-transparent"></textarea>
    </div>
</div>
