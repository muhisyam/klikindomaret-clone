    ...
    <section class="flex items-center justify-between">
        ...
        <div class="w-1/4">
            <div class="flex items-center float-right">
                ...
                <div class="h-7 w-[1px] bg-light-gray-100 mx-3"></div>
    ...
    <section>
        <ol class="inline-flex items-center text-sm">
            <li class="text-light-gray-400">
                <x-nav-link class="leading-none cursor-pointer hover:text-secondary" href="{{ route('products.index') }}" value="Kategori"/>
            </li>
