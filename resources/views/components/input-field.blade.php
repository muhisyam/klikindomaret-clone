...
<input {{ $attributes->class(['border-light-gray-50' => ! $isError, 'border-red-600' => $isError])->merge(['class' => 'h-10 w-full rounded-md border border-light-gray-50 py-2 px-3 text-sm text-black' . $classes, 'type' => 'text']) }}>